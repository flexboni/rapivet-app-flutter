...
class opencv_originals_ex {

  img_proc_ex() async{

    String filePath = Statics.current_capturedFileName;
    ...
    //dynamic res =await ImgProc.adaptiveThreshold(await file.readAsBytes(), 125,
     //   ImgProc.adaptiveThreshMeanC, ImgProc.threshBinary, 11, 12);
    dynamic res =  await ImgProc.canny(await file.readAsBytes(), 50, 200);

    DateTime time2= DateTime.now();


    Duration gap = time2.difference(time1);
    print("opencv 시간: "+gap.inMilliseconds.toString());
    print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
